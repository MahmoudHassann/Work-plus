...
export class ChatService
{
    ...
    getChats(): Observable<any>
    {
        ...
        return this._httpClient.get(`${this.BaseURL}chats`).pipe(
            tap((response: any) => {
                this._chats.next(response);
            })
        )
    }
    sendMSG(id:any,msg:any): Observable<any>
    {
        
        return this._httpClient.post(`${this.BaseURL}sendMSG/${id}`,msg)
    }
    ...
    {
        return this._httpClient.get(`${this.BaseURL}getMSG/${id}`).pipe(
            map((chat)=>{
                console.log(chat);
