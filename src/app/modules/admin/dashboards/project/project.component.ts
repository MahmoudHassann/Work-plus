...
export class ProjectComponent implements OnInit, OnDestroy, OnChanges {
    ...
    sendAll(msg:any)
    {
        ...
        console.log(msg);
        this._userService.sendToAll(msg).subscribe({
            next:(res)=>{
                console.log(res);
                this.MSG.reset()
    ...
    {
        const msg ={
            title:this.MSG.value.title,
            body:this.MSG.value.body
        }
        this.sendAll(msg)
    }
               ...
               /*  console.log(res); */
                if (res.Message === 'Done') {
                 /*    console.log(res.identity); */
                   ...
                   /*  this.images = res.identity.cardFace
