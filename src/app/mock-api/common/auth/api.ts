...
export class AuthMockApi
{
     ...
     * Constructor
     */
    /* constructor(private _fuseMockApiService: FuseMockApiService, private _http:HttpClient)
    {
        // Set the mock-api
    ...
    /* registerHandlers(): void
    {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost(`${this.BaseURL}signin`, 1500)
            .reply(({request}) => {
                console.log(request);
                
                // Sign in successful
                if ( request.body.email === 'admin@admin.com' && request.body.password === 'admin123' )
                {
                    return [
                        200,
                        {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost(`${this.BaseURL}/verifyToken`)
            .reply(({request}) => {
                console.log(request);
